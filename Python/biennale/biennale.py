...
retour: la valeur calibrée de 0 à 16
"""
def meas_val(valeur):
    if (valeur == 'cpu'):
        # retouche de la valeur pour entre comprise entre 0 et 16
        return (int((psutil.cpu_percent() * 16) / 100))
    elif (valeur == 'mem'):
        return (int((mem.percent * 16) / 100))
    else:
