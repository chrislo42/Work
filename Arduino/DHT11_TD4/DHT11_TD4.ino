...
void loop() {
  ...
  http.begin("http://192.168.0.16/workspace/num_4/temp.cfg"); //HTTP mettre la bonne adresse IP
  ...
  String adresse = "http://192.168.0.16/workspace/num_4/save_data.php?data=" +donnee;
