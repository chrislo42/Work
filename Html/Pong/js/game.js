var game = {
  ...
  displayScore : function(scorePlayer1, scorePlayer2) {
    ...
    if (scorePlayer1 < 10 && scorePlayer2 < 10) {
      ...
      game.display.drawTextInLayer(this.scoreLayer, "Player One", "10px Arial", "#FF0000", 30, 20);
      game.display.drawTextInLayer(this.scoreLayer, "Player Two", "10px Arial", "#FF0000", this.groundWidth-80, 20);
